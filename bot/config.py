...
try:
    APP_ID = config("7405235", cast=int)
    API_HASH = config("5c9541eefe8452186e9649e2effc1f3f")
    BOT_TOKEN = config("5534205730:AAGqKRKCrvmG_T37Q-jNUMDHZqmxQc0QYeg")
    DEV = 1615607413
    OWNER = config("1164918935")
